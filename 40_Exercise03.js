let arr = ["What do kids play when their mom is using the phone ? Bored games.",
...
// let flag = confirm("Do you want to hear a jock ?");
// while (flag) {
//     let i = parseInt(54 * Math.random());
//     document.getElementById("demo").innerHTML = arr[i];
    // flag = confirm("Do you want to hear a jock ?");
// }
